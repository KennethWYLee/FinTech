...
| --- | ---: | --- | --- |
| Financial question | 1 | What decision, available information, comparison, and evidence would make an investment idea testable? | A revised quantitative trading question that states the conditions held fixed, a result that would not support the idea, and the remaining limitations. |
...
| Weighting-method research | 11–13 and 15 | How can a limitation of an established method motivate a precise and testable modification? | Source-based method analysis and development of a proposed modification. Specific papers will be announced later. |
| Report 2 | 14 | Can the team state its proposed weighting-method modification and present preliminary evidence? | A frozen Git version that connects the cited method, identified limitation, proposed change, and preliminary comparison. |
...
English: Week 1 shows how to convert a general investment idea into a testable quantitative trading question by specifying the decision, available information, outcome, baseline, conditions held fixed, evidence, and limitations.

中文：第一週說明如何明確定義決策、資訊範圍、結果、比較基準、固定條件、證據與限制，將一般投資想法改寫成可檢驗的量化金融問題。
...
The [course statement and GenAI policy](course/GenAI使用規範.md) apply throughout the semester. Detailed report instructions are provided for [Report 1](course/week10_main.md), [Report 2](course/week14_main.md), and the [final report](course/week16_main.md).
