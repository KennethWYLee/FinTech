...
- 最後盤點日期：2026-08-27
- 課程狀態：115-1 課綱與18週結構已完成；12個實際授課週（Weeks 2–8、11–13、15與18）均已各自完成150分鐘改寫與重新驗證；三次報告與課堂參與已有可直接供教師核定的完整試行規則，正式共同資料、課堂環境與數值設定仍依下方待確認事項辦理
...
- 課程LMS是正式提交管道。12個授課週的平時證據原則上於課後48小時提交；Report 1與
  Report 2於報告前48小時凍結，final report於Week 16前72小時凍結。Report 1個人比較、
...
- 2026-08-27完成課堂參與與三次報告的完整試行規則；依教師最新決定，配分為40%、15%、15%與30%，
  明確區分團隊及個人證據、可觀察判準、LMS提交格式與截止時間、工作量、內容上限、版本凍結、
  無準時版本的處理、回饋時點、隱私、調整安排及同儕排序。Report 1與final排序均使用五個
  0–10共同評分面向及合計100%的權重，收到的名次不影響團隊分數。GenAI規範已提供等義英文
  與中文內容，並補齊資料隱私、人工查證與口頭問答責任。
- 四份評分表分別加總為40、15、15及30分，課綱總配分為100%；Weeks 10、14、16與17的活動
